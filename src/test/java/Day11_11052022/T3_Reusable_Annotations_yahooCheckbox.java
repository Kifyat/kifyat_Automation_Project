...
public class T3_Reusable_Annotations_yahooCheckbox extends Reusable_Annotations {
...
//next we need to click on sign in button
        ...
        //we need to verify that signed in option checked
    ...
    public void tc002_verifySignedInOptionIsUnchecked() {
        ...
        ReusableActions.clickAction(driver, "//*[@class = 'stay-signed-in checkbox-container']", "Element name");
        //we need to verify that sign option is checked
        boolean isSignInChecked = driver.findElement(By.xpath("//*[@id= 'persistent']")).isSelected();
        System.out.println("The checkbox check condition is: " +isSignInChecked);
